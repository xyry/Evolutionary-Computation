...
class GeneticAlgorithm(object):
    ...
    def transformDNA(self, population):
        population_decimal = (
                    (population.dot(np.power(10, np.arange(self.DNA_size)[::-1])) / np.power(10, self.DNA_size)) *
...
def main():
    ga = GeneticAlgorithm(cross_rate=0.9, mutation_rate=0.1, n_population=300, n_iterations=2000)
    ga.evolution()
